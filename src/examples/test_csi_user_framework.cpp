...
int main(int argc, char** argv)
{
  ...
  // TODO(bbannier): Add a principal to use for reservations to this
  // framework. We typically expect an environment variable
  // `DEFAULT_PRINCIPAL` to be set and use its value.

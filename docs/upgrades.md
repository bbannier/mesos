...
<a name="0-29-allocator-metrics"></a>

* The names of the metrics of the Mesos allocator are changed to be prefixed with <code>allocator/mesos/</code> instead of just <code>allocator/</code>. The existing name <code>allocator/event_queue_dispatches</code> is now deprecated and will be removed with 0.30.
